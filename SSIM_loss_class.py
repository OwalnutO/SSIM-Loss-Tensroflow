...
if __name__ == "__main__":
    ...
    img1 = scipy.misc.imread('00023_4_00023_2.png', mode='RGB').astype('float32')
    img2 = scipy.misc.imread('00031_1_00031_7.png', mode='RGB').astype('float32')

    # results using skimage
    ssim_skimage = compare_ssim(img1, img2, win_size=11, data_range=255, multichannel=True, gaussian_weights=True,  use_sample_covariance=False, K1=0.01, K2=0.02, sigma=1.5)
    print('ssim from skimage is %f' % ssim_skimage)
